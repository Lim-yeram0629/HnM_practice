	...
	<section>
		...
		<div class="container mt-5 px-2"
			...
			<div class="position-relative">
				...
				<form id="searchForm"
					action="${ pageContext.servletContext.contextPath }/management/honeyTip"
					method="get">
		...
		<ul class="nav nav-pills" style="background-color: #FFEDBD;">
			<a class="fixed dropdown-toggle" data-toggle="dropdown" href="#"
				role="button" aria-expanded="false"> <img
				src="./resources/images/chat_icon.png" width="80" height="80">
			</a>
			<ul class="dropdown-menu" role="menu">
				<li><a href="#">1:1채팅</a></li>
				<li><a href="#">그룹채팅</a></li>
				<li><a href="#">동네오픈채팅</a></li>
			</ul>
		</ul>
	</section>
	<script>
