...
<body style="background: #FFEDBD;">
	<header>
		...
		<div class="sidebar-container">
			...
			<ul class="sidebar-navigation">
				...
				<li><a
					href="${ pageContext.servletContext.contextPath }/management/custServiceCenter"
					id="custServiceCenter"> <i class="fa fa-modifyInfo"
						aria-hidden="true"></i> 공지사항
				</a></li>
				<li><a
					href="${ pageContext.servletContext.contextPath }/management/qna"
					id="qna"> <i class="fa fa-myContents" aria-hidden="true"></i>
						자주 묻는 질문
				</a></li>
			</ul>
		</div>
	...
	<section style="padding-left: 10%;">
		...
		<div class="boardtitle3">
			<button type="button" class="btn btn-default" id="deleteBtn">글
				삭제</button>
			<button type="button" class="btn btn-default"
				onclick="location.href='${ pageContext.servletContext.contextPath }/management/posting?boardCode=4_L0'">글
				작성</button>
		</div>
		...
		if (document.getElementsByTagName("td")) {
			...
			for (let i = 0; i < $tds.length; i++) {
				...
				$tds[i].onclick = function() {
					...
					console.log(postNo);
					location.href = "${ pageContext.servletContext.contextPath }/management/post?postNo="
							+ postNo + "&boardCode=4_L0";
				}
			}
		}
	</script>
