...
<body style="background: #FFEDBD;">
  ...
  <section>
    ...
    <c:set var="boardCode" value="2_${sessionScope.member.locationCode }"/>
      ...
      <div class="mb-2 d-flex justify-content-between align-items-center">
          ...
          <li><a href="#">1</a></li>
			...
			<div class="position-relative">
				...
				<form id="searchForm"
					action="${ pageContext.servletContext.contextPath }/board/honeytippage"
					method="get">
  ...
  <!-- Footer -->
	...
	<script>
		...
		$('#writingPost').click(function () {
					...
					location.href = "${ pageContext.servletContext.contextPath }/board/insertandupdate?boardCode=2_"+ "${sessionScope.member.locationCode }";
