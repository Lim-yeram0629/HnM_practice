...
<body>
    ...
    <nav>
        <div class="container">
            <div></div>
            <a href="${ pageContext.servletContext.contextPath }/board/mainpage" id="main_logo"><h1>Honey-tip n Meeting</h1><h1 style="color: #2A8BF2; padding-top: 4px;">&nbsp;&nbsp;게시글 작성</h1></a>
        </div>
    </nav>
    ...
    <section style="display: flex; justify-content: space-between;">
        ...
        <div class="container" style="flex-direction: column; width: 100%; min-height: 800px;">
            ...
            <div class="main_con" style="min-width: 600px;">
                ...
                <form action="${ pageContext.servletContext.contextPath }/board/insertandupdate" method="post" onsubmit="return validate();">
                    <table>
                        <tr>
                    ...
                    <input type="hidden" name="modiType" id="modiType"><!-- 기존 페이지 존재하는지 확인(하단부 script) -->
