				...
				<div class="col-md-10" style="margin-top: 10px;">
					<div class="row">
						<form id="searchForm" method="get"
							action="${ pageContext.servletContext.contextPath }/board/customerpage">
							<div class="col-md-3">
				...
				<table class="table table-responsive table-borderless">
					...
					<tbody>
						<c:forEach var="notice" items="${requestScope.noticeList }">
							<input type="hidden" value='${ notice.postNo }'>
							<tr onclick="movePost(this)" >
								<td><c:out value="${ notice.postDate }" /></td>
								<td><c:out value="${ notice.postTitle }" /></td>
								<td>관리자</td>
								<td class="text-end"><span class="fw-bolder">${ notice.cntView }</span>
